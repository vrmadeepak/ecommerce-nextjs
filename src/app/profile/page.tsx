    ...
    <main className="w-full sm:w-6/12 lg:w-4/12 xl:w-4/12 space-y-3 rounded-3xl bg-white z-10">
      ...
      <div className="overflow-y-scroll" style={{paddingBottom: "56px"}}>
        <div className="fixed top-0 bg-white h-16 w-full bg-center object-cover z-1 shadow-lg flex items-center" >
          ...
          <div className="px-3 flex w-full align-middle items-center">
            {/* <div className="flex-initial">
              <div className="flex justify-end items-center relative">
                <div className="inline relative">
                  <div className="block flex-grow-0 flex-shrink-0">
                    <img className="rounded-xl w-8 h-8 border border-yellow-300 shadow" src="https://placehold.co/24x24" />
                  </div>
                </div>
              </div>
            </div> */}
            ...
            <h4 className="text-xl font-normal  leading-tight truncate">Jugnu
            </h4>
          </div>
        ...
        <div style={{marginTop: "4rem"}}>
          <Setting text="firefly" imageSrc="https://avatars.githubusercontent.com/u/124555022?v=4" />
          <Setting text="Interests" icon={FaRegHeart} />
          <Setting text="Squad" icon={MdOutlineGroupAdd} />
          {/* <Setting text="My Info" icon={MdInfoOutline} /> */}
          <Setting text="Privacy" icon={MdLockOutline} />
          <Setting text="Settings" icon={MdOutlineSettings} />
          {/* <Setting text="Interests" icon={IoMdHeart} />
          <Setting text="Squad" icon={MdGroup} />
          <Setting text="My Info" icon={MdInfoOutline} />
          <Setting text="Privacy" icon={MdLockOutline} />
          <Setting text="Settings" icon={MdOutlineSettings} />
          <Setting text="Interests" icon={IoMdHeart} />
...
function Setting({text, imageSrc, icon: Icon}: SettingsProps) {
  return (
            ...
            <div className="flex flex-col justify-center w-full px-2 py-1">
              <div className="flex justify-between items-center ">
                <div className="flex items-center">
                  <div className="mr-2 text-gray-500 text-2xl font-light w-8 h-8 flex items-center justify-center rounded-full">
                      {Icon && <Icon />}
                      {imageSrc && <img className="w-full h-full rounded-full border border-gray-700" src={imageSrc} />}
                  </div>
